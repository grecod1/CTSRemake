...
namespace Helpline.App_Start
{
    ...
    public class IndentityConfig
    {
        ...
        {
            app.CreatePerOwinContext(() => new HelplineDbContext());
            app.CreatePerOwinContext<UserManager>(UserManager.Create);
            app.CreatePerOwinContext<RoleManager<Role>>((options, context) =>
                new RoleManager<Role>(
                    new RoleStore<Role>(context.Get<HelplineDbContext>())));
    ...
    {
        var manager = new UserManager(new UserStore<User>(context.Get<HelplineDbContext>()));
